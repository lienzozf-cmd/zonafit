...
const socialLinks = [
    { 
        ...
        alt: "WhatsApp", 
        color: "#25D366",
        glow: "drop-shadow-[0_0_6px_rgba(37,211,102,0.9)]",
    ...
    { 
        ...
        alt: "TikTok",
        color: "#E2E8F0",
        glow: "drop-shadow-[0_0_6px_rgba(226,232,240,0.9)]",
    ...
    { 
        ...
        alt: "Instagram",
        color: "#E1306C",
        glow: "drop-shadow-[0_0_6px_rgba(225,48,108,0.9)]",
    ...
    { 
        ...
        alt: "Facebook",
        color: "#1877F2",
        glow: "drop-shadow-[0_0_6px_rgba(24,119,242,0.9)]",
    ...
    return (
        <div className="social-sidebar">
            {socialLinks.map(link => (
                <a href={link.href} key={link.alt} target="_blank" rel="noopener noreferrer" className="social-sidebar-icon">
                    <div className="flex items-center justify-center w-[20px] h-[20px]">
                        <svg viewBox="0 0 24 24" fill={link.color} className={`w-full h-full ${link.glow} hover:scale-110 transition-transform duration-300`}>
                            <path d={link.path}/>
                        </svg>
                    </div>
                </a>
