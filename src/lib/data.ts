...
export const products: Product[] = [
  ...
  },
  {
    ...
    subcategory: 'rgmnt',
    brand: 'RGMNT',
    images: [{ src: '/assets/images/marcas/rgmnt/tridente.png', alt: 'Gold Rope Chain', dataAiHint: 'gold chain', option: 'Gold' }],
    options: { type: 'material', values: [{ value: 'Gold', stock: 10 }] },
  },
  {
    id: 2302,
    ...
    subcategory: 'rgmnt',
    brand: 'RGMNT',
    images: [{ src: '/assets/images/marcas/rgmnt/tridente.png', alt: 'Gold Rope Bracelet', dataAiHint: 'gold bracelet', option: 'Gold' }],
    options: { type: 'material', values: [{ value: 'Gold', stock: 10 }] },
  },
  {
    id: 2303,
    ...
    subcategory: 'rgmnt',
    brand: 'RGMNT',
    images: [{ src: '/assets/images/marcas/rgmnt/tridente.png', alt: 'Silver Rope Chain', dataAiHint: 'silver chain', option: 'Silver' }],
    options: { type: 'material', values: [{ value: 'Silver', stock: 10 }] },
  },
  {
    id: 2304,
    ...
    subcategory: 'rgmnt',
    brand: 'RGMNT',
    images: [{ src: '/assets/images/marcas/rgmnt/tridente.png', alt: 'Silver Rope Bracelet', dataAiHint: 'silver bracelet', option: 'Silver' }],
    options: { type: 'material', values: [{ value: 'Silver', stock: 10 }] },
  },
  {
    id: 2400,
  ...
  {
    id: 2610,
    name: 'The Boys Graphic Tees (Q.430)',
    price: 'Q.430.00',
    availability: 'Disponible',
  ...
  },
  {
    ...
    options: { type: 'color', values: [{ value: 'Azul', stock: 10 }, { value: 'Negra', stock: 10 }] },
  },
  {
    id: 2619,
  ...
  },
  {
    ...
    price: 'Q.225.00',
    availability: 'Disponible',
    description: 'Shaker de Dragon Pharma con diseño exclusivo "Tu Marido Moises".',
    gender: 'unisex',
    category: 'accesorio',
    subcategory: 'shaker',
    brand: 'Dragon Pharma',
    images: [{ src: '/assets/images/marcas/dragonpharma/TU MARIDO MOISES SHAKER CUP.png', alt: 'Shaker Tu Marido Moises', dataAiHint: 'shaker bottle', option: 'Único' }],
    options: { type: 'color', values: [{ value: 'Único', stock: 10 }] },
  },
  {
    id: 2622,
    ...
    price: 'Q.225.00',
    availability: 'Disponible',
    description: 'Shaker de 14oz de Gymshark, práctico y funcional.',
    gender: 'unisex',
    category: 'accesorio',
    subcategory: 'shaker',
    brand: 'Gymshark',
    images: [{ src: '/assets/images/accesorios/shakers/shaker-gymshark.png', alt: '14OZ Shaker Bottle', dataAiHint: 'shaker bottle', option: 'Único' }],
  ...
  },
  {
    ...
    subcategory: 'equipo',
    brand: 'Gymshark',
    images: [{ src: '/assets/images/accesorios/equipo/straps-gymshark.png', alt: 'Silicone Grip Lifting Straps', dataAiHint: 'lifting straps', option: 'Lila' }],
  ...
  },
  {
    ...
    subcategory: 'equipo',
    brand: 'Gymshark',
    images: [{ src: '/assets/images/accesorios/equipo/straps-gymshark.png', alt: 'Silicone Grip Lifting Straps', dataAiHint: 'lifting straps', option: 'Negro' }],
  ...
  },
  {
    ...
    subcategory: 'calcetin',
    brand: 'Gymshark',
    images: [{ src: '/assets/images/accesorios/calcetines/calcetines-setsnreps.png', alt: 'Sets and Reps 3pk Crew Socks', dataAiHint: 'fitness socks', option: 'S' }],
    options: { type: 'color', values: [{ value: 'negro, blanco y verde', stock: 10 }] },
  },
  {
    id: 2626,
